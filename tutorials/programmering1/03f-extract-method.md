...
- **Ret navnene** på metoder og parametre, så koden bliver mere forståelig - `check`, `checkThis`, osv. er der jo ingen der forstår.
...
public class PhoneHome {
    public static void main(String[] args) {
        ...
        System.out.println("Er telefonnummeret et gyldigt dansk telefonnummer? " + check(phoneNumber));
    }
